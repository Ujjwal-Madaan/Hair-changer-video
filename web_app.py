...
st.markdown(f'''
<a href={url}><button style="background-color: #4B56D2;border-radius: 8px;border-style: none;box-sizing: border-box;color:#FFFFFF;">Try our Beta Version</button></a>''',unsafe_allow_html=True)
